...
<?php if (get_option('enews_feedburner') == 'on') { ?>
	...
	<link rel="alternate" type="application/rss+xml" title="<?php bloginfo('name'); ?> RSS Feed" href="<?php echo esc_attr(get_option('enews_feedburner_rss')); ?>" />
...
<body <?php if (is_home()) echo('id="home"');?> <?php body_class(); ?>>
	...
	<div id="header">
		...
		<div class="container">
				...
				<ul id="<?php echo $menuID; ?>" class="<?php echo $menuClass; ?>">
					...
					<?php if (get_option('enews_swap_navbar') == 'false') { ?>
						...
						<?php if (get_option('enews_home_link') == 'on') { ?>
							...
							<li <?php if (is_home()) echo('class="current_page_item"') ?>><a href="<?php bloginfo('url'); ?>"><?php esc_html_e('Home','eNews') ?></a></li>
			...
			<a href="<?php bloginfo('url'); ?>"><?php $logo = (get_option('enews_logo') <> '') ? get_option('enews_logo') : get_bloginfo('template_directory').'/images/logo.jpg'; ?>
	...
	<div id="content">
		...
		<div class="container">
			...
			<?php if (get_option('enews_leader_enable') == 'on') { ?>
				...
				<div class="<?php if (is_home()) echo('leader-home'); else echo('leader') ?>"><a href="<?php echo esc_url(get_option('enews_leader_url')); ?>"><img src="<?php echo esc_url(get_option('enews_leader_image')); ?>" alt="leader" /></a></div>
